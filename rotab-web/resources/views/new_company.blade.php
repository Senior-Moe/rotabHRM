    ...
    <form action="" method="post">
        ...
        <div class="form-row mb-4">
            <div class="col-md">
                ...
                <input type="text" class="form-control" name="company_name" placeholder="e.g شركة دانس ذات المسؤولية المحدودة" required>
            </div>
            <div class="col-md">
            ...
            <div class="rol-md">
                ...
                <input type="text" class="form-control" name="company_name" placeholder="www.example.com">
            </div>
            <div class="col-md">
                <label>{{__('Company Authintcation')}}</label>
                <input type="text" class="form-control" name="company_name" placeholder="www.example.com/12345">
            </div>
        </div>
        <div class="form-row mb-4">
        <div class="col-md">
        ...
        <div class="form-row mb-4">
            <div class="col-md">
                ...
                <input type="text" class="form-control mb-2" name="first_manager_in_cr_en" placeholder="English" required>
            </div>
            <div class="col-md">
        ...
        <div class="form-row mb-4">
            ...
            <div class="col-md">
                ...
                <input type="text" class="form-control" name="company_phone_number" placeholder="966XXXXXXXXX" required>
            </div>
            <div class="col-md">
